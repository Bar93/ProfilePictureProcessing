public class Constant {
    ...
    public static final int PANEL_BUTTON_X = 0;
    public static final int PANEL_BUTTON_Y = 0;
    public static final int PANEL_BUTTON_HEIGHT = 700;
    public static final int PANEL_BUTTON_WIDTH = 500;
    public static final int BUTTON_X = 100;
    public static final int BUTTON_Y = 400;
    public static final int BUTTON_SPACE_Y = 50;
    public static final int BUTTON_SPACE_X = 50;
